...
export function Login() {
  ...
  return (
    <div className="flex flex-col items-center justify-center">
      <h1 className="text-3xl font-bold mt-3 mb-6">Login</h1>
      <input
      ...
      <button
        className="bg-gray-300 font-bold hover:bg-gray-500 mt-4 py-2 px-4 rounded focus:outline-none focus:shadow-outline"
        onClick={handleLogin}
      >
        Login
      </button>
